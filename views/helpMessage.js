const helpMessage = () => {
  ...
  answer += ':question: *Can I set different settings for different channels* > Yes, translation settings can be added to any public channel.\n\n';
  answer += ':question: *Can I translate messages in private channels or direct messages* > Not yet, unfortunately. We are working on private channels right now, and we are exploring supporting DMs as well. Please let us know if this is a key feature for your team.\n\n';
