const helpMessage = () => {
  ...
  answer += ':question: *Can I set different settings for different channels* > Yes, translation settings can be added to any *public* channel. You can also add workspace-wide settings that will be applied if that channel has no specific settings.\n\n';
  answer += ':question: *Can I translate messages in private channels or direct messages* > Unfortunately, no. This app was built for team-wide multilingual communications, but do let us know if you would like this or any other feature.\n\n';
