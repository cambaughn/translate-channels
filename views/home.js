...
const buildHomeView = async (userId, teamId, redirect_url, userIsAdmin, client) => {
  ...
  let auth_url = `https://slack.com/oauth/v2/authorize?user_scope=channels:history,chat:write,users:read&client_id=${process.env.CLIENT_ID}&redirect_uri=${redirect_url}`;
